...
(function () {
    ...
    function init(attempt = 0) {
        ...
        // ✅ Abort if Wave Addon filter panel is present
        ...
        // Keep panel open while hovering inside
        wrapper.addEventListener("mouseenter", () => {
            clearTimeout(closeTimeout);
        });

        // Close after mouse leaves wrapper
        ...
        function filterMonsters() {
            ...
            document.querySelectorAll(".monster-container .monster-card")
                .forEach(card => {
                    ...
                    card.style.display =
                        (showAll || selected.includes(name)) ? "" : "none";
                });
        }
